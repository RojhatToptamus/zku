 ...
 */
    ...
    modifier voteEnded(uint proposalId){
        require(((block.timestamp - proposals[proposalId].startTime) <= 5 minutes), "Vote period end!");
        _;
    }
    ...
    function vote(uint proposal) external voteEnded(proposal) {
        Voter storage sender = voters[msg.sender];
